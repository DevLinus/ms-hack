...
const CarouselItem = ({hidden, id}: CarouselItemProps) => {
    ...
    const className = carouselItemClassName + extra
...
const Carousel = () => {
    ...
    const handlePrev = () => setActiveItem(activeItem === 0 ? activeItem : activeItem - 1)
    const handleNext = () => setActiveItem(activeItem === 2 ? activeItem : activeItem + 1)
    return (
        <div
